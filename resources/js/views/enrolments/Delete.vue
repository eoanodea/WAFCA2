<template>
    <div>
        <md-dialog 
            ...
            <md-dialog-title>Are you sure you want to delete this enrolment?</md-dialog-title>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions({
                deleteEnrolment: 'enrolment/deleteEnrolment'
            }),
        }
    }
</script>