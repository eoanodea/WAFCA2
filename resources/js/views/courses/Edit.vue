<template>
    <form novalidate class="signin md-layout" @submit.prevent="validateCourse">
        <md-card class="md-layout-item md-size-50 md-small-size-100">
        <md-card-header>
          <div class="md-title">Edit Course</div>
        </md-card-header>
        <md-card-content>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadCourse () {
                this.$store.dispatch('course/loadCourse', parseInt(this.$route.params.id)).then(() => {
            ...
            saveCourse() {
                let app = this
                app.sending = true
                app.updateCourse([parseInt(app.$route.params.id), this.form])
                .then((id) => {
                    app.sending = false
                    app.success = true
                    this.$router.replace({
